#ifndef BPHAnalysis_SpecificDecay_BPHK0sToPiPiBuilder_h
#define BPHAnalysis_SpecificDecay_BPHK0sToPiPiBuilder_h
...
class BPHK0sToPiPiBuilder {
 ...
 private:
  ...
  template <class T> void buildFromV0( const T* v0Collection );
